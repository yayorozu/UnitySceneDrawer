...
{
    internal static class EditorImageDrawer
    {
        private const string MENU_PATH = SceneDrawerUtility.TOOL_PATH + "Show Image UV";
        ...
        private static void DrawGizmo(Image image, GizmoType type)
        {
            ...
            using (new HandlesMatrixScope(image.transform))
            {
